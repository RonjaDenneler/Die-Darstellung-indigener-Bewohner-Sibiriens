...
with open('C:/Users/ronja/OneDrive/Desktop/ZeltlebeninSibiren.txt', 'r', encoding="UTF-8") as file:
    zelttxt = file.read()
...
tokenlist = [token.text for token in doc1]
poslist = [token.pos_ for token in doc1]
